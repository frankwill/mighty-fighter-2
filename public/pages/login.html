  ...
  <form>
    <div class="form-login__container pa-5 d-flex flex-column justify-content-center row-gap-5">
      <div>
        ...
        <input type="text" class="form-login__input py-2 px-3 text-h6 color-neutral-light">
      </div>
  
      <div>
        <label class="text-h3 d-flex flex-column" for="">SENHA</label>
        <input type="password" class="form-login__input py-2 px-3 text-h6 color-neutral-light">
      </div>
