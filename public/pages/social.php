<section class="container d-flex flex-column align-items-center row-gap-5">
  ...
  <span class="text-body text-center">
    Fique  por dentro de todos detalhes sobre o mundo de Mighty Fighter 2! Fique ligado em nossas atualizações para se manter sempre à frente e junte-se à nossa comunidade para compartilhar suas melhores jogadas, artes e estratégias favoritas!
  </span>
  <hr class="line-divider">
  <div class="card__container d-flex wrap gap-5 justify-content-start">
